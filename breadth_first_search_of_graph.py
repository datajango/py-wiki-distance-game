...
# more than once, we use a boolean visited array. For simplicity, 
...
# When we come to vertex 0, we look for all adjacent vertices of it. 2 
# is also an adjacent vertex of 0. If we don’t mark visited vertices, 
